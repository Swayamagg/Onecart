  ...
  <div className='flex'>
    <div className='w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12'>
        <form onSubmit={handleSubmit} className='w-full max-w-md  bg-white p-8 rounded-lg border shadow-sm'>
            ...
            <div onClick={handleLogin} className='w-[100%] h-[50px] bg-black text-white rounded-lg flex items-center justify-center gap-[10px] py-[20px] cursor-pointer'>
            ...
            <button type='submit' className='w-full mt-7 bg-black text-white p-2 rounded-lg font-semibold hover:bg-gray-800 transition'>Sign In</button>
    ...
    <div className='hidden md:block w-1/2 bg-gray-800'>
       <div className='h-full flex flex-col justify-center items-center'>
        <img src={login} alt="Login img" className='h-[750px] w-full object-cover' />
       </div>
    </div>
  </div>
  )
